                ...
                <form action="backend/register.php" method="post" onsubmit="return validate();">
                    ...
                    <div class="form-options">
                        <div class="terms-conditions">
                            ...
                            <label for="terms">I accept the <a href="info/tos.php" target="_blank">Terms of Service</a> & <a href="info/privacy-policy.php" target="_blank">Privacy Policy</a></label>
                        </div>
                    </div>
    ...
    <footer>
        <div class="content">
            <section class="footer-links">
                <ul>
                    <li><a class="link" href="info/privacy-policy.php" target="_blank">Privacy Policy</a></li>
